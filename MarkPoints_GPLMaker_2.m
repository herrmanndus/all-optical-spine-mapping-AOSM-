function GPL = MarkPoints_GPLMaker2(Xpx, Ypx, IsSpiral, SpiralSizeUM, SpiralRevolutions, SaveName)
% Lloyd Russell 20151119
% last update DH 11/2018: changed spiral settings to be non-negative (gave
% errors when loading into MarkPoints)
...
for i = 1:NumPoints
	PointList{i} = [...
        ...
        'Duration="10" '...
        'IsSpiral="' IsSpiral '" '...
        'SpiralSize="' num2str(SpiralSizeV(2)) '" '...
